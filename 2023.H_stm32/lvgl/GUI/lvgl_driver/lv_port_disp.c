...
static lv_color_t buf_2_1[800*60] __attribute__((section(".ARM.__at_0x24000000")));	//定义最大屏分辨率时,LCD所需的帧缓存数组大小
static lv_color_t buf_2_2[800*60] __attribute__((section(".ARM.__at_0x24017700")));	//定义最大屏分辨率时,LCD所需的帧缓存数组大小
...
//    lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_2_1, buf_2_2, MY_DISP_HOR_RES * 10);   /*Initialize the display buffer*/
    ...
    lv_disp_draw_buf_init(&draw_buf_dsc_2, buf_2_1, buf_2_2, 800*60);   /*Initialize the display buffer*/
